...
static WebDriver driver;
	...
	public static WebDriver startBrowser() throws Exception{
		...
		if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("chrome")){
			...
			System.setProperty("webdriver.gecko.driver","D:\\Batch80\\StockAccountingHybrid\\drivers\\geckodriver.exe");
			driver=new FirefoxDriver();
		}else if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("ie")){
			System.setProperty("webdriver.internetexplorer.driver","D:\\Batch80\\StockAccountingHybrid\\drivers\\IEDriverServer.exe");
